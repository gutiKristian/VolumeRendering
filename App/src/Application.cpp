...
namespace med {
	...
	void Application::InitializeTextures()
	{
		...
		DicomReader reader;
		std::unique_ptr<StructureFileDcm> contourFile = reader.ReadStructFile("716^716_716_RTst_2013-04-02_230000_716-1-01_OCM.BladderShell_n1__00000/");
		std::unique_ptr<VolumeFileDcm> ctFile = reader.ReadVolumeFile("assets\\716^716_716_CT_2013-04-02_230000_716-1-01_716-1_n81__00000", true);
