...
namespace med {
	...
	private:
		...
		float m_CubeVertexData[48] = {
			/*,	   x     y      z     u	  v	   w */
				 -0.5f, -0.5f,  0.15f,	0.0f, 0.0f, 0.0f,
				  0.5f, -0.5f,  0.15f,	1.0f, 0.0f, 0.0f,
				 -0.5f,  0.5f,  0.15f,	0.0f, 1.0f, 0.0f,
				  0.5f,  0.5f,  0.15f,	1.0f, 1.0f, 0.0f,
				 -0.5f, -0.5f, -0.15f,	0.0f, 0.0f, 1.0f,
				  0.5f, -0.5f, -0.15f,	1.0f, 0.0f, 1.0f,
				 -0.5f,  0.5f, -0.15f,	0.0f, 1.0f, 1.0f,
				  0.5f,  0.5f, -0.15f,	1.0f, 1.0f, 1.0f
		};
